  ...
  <div class="home">
    ...
    <el-row class="mt6" type="flex" justify="space-between">
      ...
      <el-col :span="8" class="bl3" style="width: 32vw">
        ...
        <div class="charts-1" id="eCharts-3">
        </div>
      </el-col>
    </el-row>
    ...
    <el-row type="flex" justify="space-between">
      ...
      <el-col :span="8" class="bl" style="width: 32vw">
        ...
        <div class="charts-1" id="eCharts-5" style="width: 90%;margin: 2vw auto">
  ...
  export default {
    ...
    mounted() {
      this.$nextTick(() => {
        ...
        this.pieCharts3 = this.$echarts.init(document.getElementById('eCharts-3'))
        ...
        this.pieCharts3.setOption(this.chartsOption3)
